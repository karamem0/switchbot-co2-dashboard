...
import MsalInteractionGate from './components/MsalInteractionGate';
            ...
            <ThemeProvider>
              <ErrorBoundary
                fallbackRender={(props) => (
                  <Error500Page error={props.error instanceof Error ? props.error : new Error(String(props.error))} />
                )}>
                <Routes>
                  <Route
                    path="/"

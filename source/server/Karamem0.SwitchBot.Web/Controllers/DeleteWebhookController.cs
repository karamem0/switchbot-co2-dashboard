...
public class DeleteWebhookController
{

    public static async Task<IResult> PostAsync(
        [FromServices()] IDeleteWebhookService service,
        [FromServices()] ILogger<DeleteWebhookController> logger,
        [FromBody()] DeleteWebhookRequest request
    )
    {
        try
        {
